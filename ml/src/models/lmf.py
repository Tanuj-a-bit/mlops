...
class LMFRecommender:
    """
    Logistic Matrix Factorization (LMF) for implicit feedback.
    """
    
    def __init__(self, factors=100, learning_rate=0.01, regularization=0.6, iterations=30):
    ...
    def _prepare_matrix(self, df):
        """Converts interaction dataframe to sparse matrix."""
